...
In your main component, import and call these functions:

#import { getBMI, generateMealPlan, orderMissingIngredients } from "./components/api";

// Example in React:
async function handleGenerate() {
  const result = await generateMealPlan(profile, preferences, pantry);
  // Do something with result
}

async function handleOrder() {
  const result = await orderMissingIngredients(missing);
